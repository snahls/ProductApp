...
import CancelEdit from '../restapi_actions/cancel_edit';
import UProduct from '../restapi_actions/update_product';
   ...
   const updateProduct=(product)=>{
    ...
    const cancelEdit=()=>{
       ...
       <tr><th align='left'>Price: </th><td><input type="text" ref={fpriceRef} defaultValue={props.product.price} /></td></tr>
        <tr><td colSpan='2' align='center'> <button value="UPDATE" onClick={()=>updateProduct(props.product)}>UPDATE</button>
